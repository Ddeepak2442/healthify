    ...
    return (
      <main className="flex min-h-screen flex-col items-center justify-between p-24  bg-slate-50 ">
        ...
        <div className="container mx-auto p-8 flex-col  text-center">
              ...
              <input type="number" id="weight" name="weight" min="1"   className="border-2 border-gray-200 rounded-md h-9" />
              <br/><br />
              <label htmlFor="height">Height: </label>
              <input type="number" id="height" name="height" min="1"  className="border-2 border-gray-200 rounded-md h-9" />
              <br/><br />
              ...
              <button  className="bg-green-500 text-white py-2 px-4 rounded">Calculate BMI</button>
              </div>
              </div>
              </div>
      </main>
